...
My research lies at the intersection of **robotics**, **computer vision**, and **reinforcement learning**, with a focus on building autonomous systems that can **perceive, understand, and act** reliably in complex, dynamic environments. Building on this, I am interested in tightly coupling **perception, learning, and planning** for **autonomous navigation**, and in **learning-based planning and control** methods that hold up in **real-world deployment**. Ultimately, my goal is to develop **autonomous robotic systems** that remain robust across diverse tasks, platforms, and environments.
